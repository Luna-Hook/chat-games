...
public final class ChatGamesCore {
  ...
  public ChatGamesCore(Platform platform) {
  ...
  public Platform platform() { return this.platform; }
  public GameManager gameManager() { return this.gameManager; }
  public GameRegistry gameRegistry() { return this.gameRegistry; }
  public ConfigManager configManager() { return this.configManager; }
}
